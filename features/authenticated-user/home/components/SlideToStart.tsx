...
const SlideToStart: React.FC<SlideToStartProps> = ({ onUnlock }) => {
  ...
  const pan = Gesture.Pan()
    .onUpdate((e) => {
      ...
      // e.translationX provides the delta since the start of the gesture
      translateX.value = Math.max(0, Math.min(MAX_X, e.translationX));
    })
    .onEnd(() => {
