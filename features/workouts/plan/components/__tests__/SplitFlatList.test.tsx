...
jestObject.mock('../../../../../components/PageDots', () => (props: any) => mockPageDots(props));

jestObject.mock('../StartWorkoutButton', () => (props: any) => mockStartWorkoutButton(props));

jestObject.mock('../../../cardio/components/StartCardioButton', () => (props: any) => mockStartCardioButton(props));
