...
const ExerciseLibrarySheet = ({
  ...
  return <SlidingBottomModal ref={modalRef} title="" snapPoints={['55%', '78%', '92%']} flatListUsage={false}>
    <View style={[styles.content, { height: height * 0.72, backgroundColor: theme.surface }]}>
      ...
      {!isLoading && <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.filters}>
        {muscles.map((muscle) => {
