...
import type { ResumeWorkoutCachePayload, StartWorkoutPageLogicReturn } from '../types/use-start-workout.types';
...
const createSplit = (overrides: Partial<WorkoutSplit> = {}): WorkoutSplit => ({
  id: 5,
  name: 'Push',
