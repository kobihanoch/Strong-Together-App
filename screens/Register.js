            ...
            try {
                const { data, error } = await supabase
                    ...
                    .insert([{
                        ...
                        // In future adding an option for loading a profile pic while signing up
                    }]);
        ...
        <KeyboardAwareScrollView contentContainerStyle={{ flex: 1 }}>
            <LinearGradient colors={['#007bff', '#004fa3']} style={{ flex: 1 }}>
                <View style={{ flex: 1, marginTop: height * 0.1 }}>
                    <View style={{ marginLeft: width * 0.05, flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <View style={styles.body}>
                        ...
                        <View style={styles.inputContainer}>
                            <InputField placeholder="Username" iconName="user" value={username} onChangeText={setUsername} />
                            <InputField placeholder="Email" iconName="at" value={email} onChangeText={setEmail} />
                            <InputField placeholder="Full name" iconName="pencil" value={fullName} onChangeText={setFullName} />
                            <InputField placeholder="Gender" iconName="venus-mars" value={gender} onChangeText={setGender} />
                            <InputField placeholder="Password" secureTextEntry={true} value={password} onChangeText={setPassword} iconName="lock" />
                            <InputField placeholder="Confirm password" secureTextEntry={true} value={confirmPassword} onChangeText={setConfirmPassword} iconName="lock" />
