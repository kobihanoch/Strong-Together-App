...
import { CachedExerciseAnalysis, ExerciseAnalysisOverview } from '../StartWorkout';
...
const RenderItem = ({
    ...
    renderedSets.push(
      <Column
        ...
        style={[
          ...
          {
            backgroundColor: isSetCompleted ? colors.completedLightTransparent : isSetInProgress ? colors.lightCardBg : '#f2f2f2ff',
        ...
        <Row style={{ gap: 10 }}>
          <View
            style={[
              ...
              {
                backgroundColor: isSetCompleted ? colors.completedLight : isSetInProgress ? colors.primary : '#a3a3a3ff',
              },
            ]}
          >
  ...
  return (
    <Column style={styles.itemCard}>
      ...
      <TouchableOpacity
        style={[styles.analyzeBtn, isAnalyzeDisabled && styles.analyzeBtnDisabled, showReadyBadge && styles.analyzeBtnReady]}
