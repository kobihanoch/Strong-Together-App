      ...
      >
        <Column style={{ marginBottom: height * 0.09 }}>
          ...
          <View style={{ alignItems: 'center', marginTop: height * 0.05 }}>
            <Text style={styles.descriptionText}>Welcome to Strong Together.{'\n'}Your goals - powered by your circle.</Text>
          </View>
            ...
            >
              {appleLoading ? (
                ...
                >
                  ...
                  <Text style={[styles.buttonLoginText, { color: 'white', fontFamily: 'Inter_600SemiBold' }]}>Sign in with Apple</Text>
                </Row>
              )}
            </TouchableOpacity>
            <TouchableOpacity
              ...
              {googleLoading ? (
                ...
                >
                  <Image
                    ...
                    cachePolicy="disk"
                  />
                  <Text style={[styles.buttonLoginText, { color: 'black', fontFamily: 'Inter_600SemiBold' }]}>Sign in with Google</Text>
                </Row>
              )}
            </TouchableOpacity>
          </Column>
          <TouchableOpacity style={styles.aboutUs} onPress={() => Linking.openURL('https://strongtogether.kobihanoch.com/privacy')}>
