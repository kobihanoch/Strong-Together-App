...
jestObject.mock('../../hooks/logic/useStartWorkoutPageLogic', () => ({
  __esModule: true,
  default: (...args: any[]) => mockUseStartWorkoutPageLogic(...args),
}));

jestObject.mock('../../components/StartWorkoutComponents/TopBar', () => (props: any) => mockTopBar(props));
jestObject.mock('../../components/StartWorkoutComponents/ExercisesSection', () => (props: any) =>
  mockExercisesSection(props),
);
...
const createLogicReturn = (
  overrides: Partial<StartWorkoutPageLogicReturn> = {},
...
jestDescribe('StartWorkout screen', () => {
  jestBeforeEach(() => {
    ...
    mockTopBar.mockImplementation(({ saveWorkout, onExit }: any) => {
      ...
      return ReactLocal.createElement(
        View,
        null,
        ReactLocal.createElement(TouchableOpacity, { onPress: saveWorkout }, ReactLocal.createElement(Text, null, 'Save')),
  ...
  jestIt('passes the route params into useStartWorkoutPageLogic and renders the modal shell', () => {
