...
import type { AuthProviderValue } from '../../../features/auth/types/auth.types';
...
jestObject.mock('../../../shared/providers/AuthProvider', () => ({
...
const fillRequiredFields = (
  ...
  const { username = 'johnny', email = 'john@example.com', password = 'Secret123', confirmPassword = 'Secret123' } = overrides;
