...
const Login = ({ route }: LoginScreenProps) => {
  ...
  const { needToVerify = false, email = null, password_: routePassword = null, username_: routeUsername = null } = route.params || {};
      ...
      <LinearGradient colors={[colors.primaryDark, colors.primary]} style={{ flex: 1 }}>
        <View style={{ flex: 1, marginTop: height * 0.08 }}>
          ...
          <View style={styles.body}>
            {needToVerify ? <VerifyCard username={routeUsername} password={routePassword} initialEmail={email} /> : <LoginForm />}
          </View>
        </View>
      </LinearGradient>
